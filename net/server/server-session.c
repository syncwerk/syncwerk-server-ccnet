...
G_DEFINE_TYPE (CcnetServerSession, syncwerk_server_ccnet_session, CCNET_TYPE_SESSION);
...
static void
syncwerk_server_ccnet_session_class_init (CcnetServerSessionClass *klass)
{
...
static void
syncwerk_server_ccnet_session_init (CcnetServerSession *server_session)
{
...
CcnetServerSession *
syncwerk_server_ccnet_session_new (const char *config_dir_r)
{
