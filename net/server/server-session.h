...
#define CCNET_TYPE_SERVER_SESSION                  (syncwerk_server_ccnet_session_get_type ())
...
GType syncwerk_server_ccnet_session_get_type ();

CcnetServerSession *syncwerk_server_ccnet_session_new ();
